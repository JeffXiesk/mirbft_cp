...
minConcurrentRequests=$((32 * 16384)) # Based on empirical data. At saturation, makes the throughput-latency plot nicely go up (as it is equivalent to may concurrent clients).
requestBufferSizes="1024"
...
segmentLengths="4"         # [entries]
viewChangeTimeouts="100000"  # [ms]
