...
# Push config files.
exec-start peers scp-output-0000-config.log stubborn-scp.sh 10 35.175.145.205:experiment-config/config-0000.yml config/config.yml
...
exec-start 1client scp-output-0000-config.log stubborn-scp.sh 10 35.175.145.205:experiment-config/config-0000.yml config/config.yml
...
# Start peers.
discover-reset 4
exec-start peers experiment-output/0000/slave-__id__/peer.log orderingpeer config/config.yml 35.175.145.205:9999 __public_ip__ __private_ip__ experiment-output/0000/slave-__id__/peer.trc experiment-output/0000/slave-__id__/prof
discover-wait

# Run clients and wait for them to stop.
exec-start 1client experiment-output/0000/slave-__id__/clients.log orderingclient config/config.yml 35.175.145.205:9999 experiment-output/0000/slave-__id__/client experiment-output/0000/slave-__id__/prof-client
...
exec-start peers scp-output-0000-logs.log stubborn-scp.sh 10 experiment-output-0000-slave-__id__.tar.gz 35.175.145.205:current-deployment-data/raw-results/
...
exec-start 1client scp-output-0000-logs.log stubborn-scp.sh 10 experiment-output-0000-slave-__id__.tar.gz 35.175.145.205:current-deployment-data/raw-results/
