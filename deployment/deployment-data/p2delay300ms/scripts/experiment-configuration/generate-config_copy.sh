...
throughputCap=131072     # The system will always be proposing requests at a rate lower than this.
...
bandwidths="10mbit"         # any value accepted by the tc command or "unlimited" !!! ATTENTION: Adapt MaxProposeDataRate in config accordingly !!!
...
throughputsAuthSinglePbft[3]="1024"
