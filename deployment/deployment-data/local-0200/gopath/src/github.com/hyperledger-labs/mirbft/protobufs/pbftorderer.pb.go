...
var file_pbftorderer_proto_rawDesc = []byte{
	...
	0x0c, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xd9, 0x01,
	...
	,
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x06, 0x64, 0x69, 0x67, 0x65, 0x73, 0x74, 0x12, 0x0e,
	0x0a, 0x02, 0x74, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x74, 0x73, 0x12, 0x0e,
	0x0a, 0x02, 0x74, 0x6e, 0x18, 0x05, 0x20, 0x01, 0x28, 0x05, 0x52, 0x02, 0x74, 0x6e, 0x22, 0x42,
	0x0a, 0x0a, 0x48, 0x74, 0x6e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x0e, 0x0a, 0x02,
	...
	0x12, 0x10, 0x0a, 0x03, 0x68, 0x74, 0x6e, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x03, 0x68,
	0x74, 0x6e, 0x22, 0x2a, 0x0a, 0x0e, 0x50, 0x62, 0x66, 0x74, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x70,
...
var file_pbftorderer_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_pbftorderer_proto_goTypes = []interface{}{
	...
	(*PbftCheckpoint)(nil),               // 4: protobufs.PbftCheckpoint
	(*PbftCatchUp)(nil),                  // 5: protobufs.PbftCatchUp
	(*PbftViewChange)(nil),               // 6: protobufs.PbftViewChange
	(*PbftMissingPreprepareRequest)(nil), // 7: protobufs.PbftMissingPreprepareRequest
	(*PbftMissingPreprepare)(nil),        // 8: protobufs.PbftMissingPreprepare
	(*PbftNewView)(nil),                  // 9: protobufs.PbftNewView
	nil,                                  // 10: protobufs.PbftViewChange.PsetEntry
	nil,                                  // 11: protobufs.PbftViewChange.QsetEntry
	nil,                                  // 12: protobufs.PbftNewView.VsetEntry
	nil,                                  // 13: protobufs.PbftNewView.XsetEntry
	(*Batch)(nil),                        // 14: protobufs.Batch
	(*CheckpointMsg)(nil),                // 15: protobufs.CheckpointMsg
	(*SignedMsg)(nil),                    // 16: protobufs.SignedMsg
}
var file_pbftorderer_proto_depIdxs = []int32{
	14, // 0: protobufs.PbftPreprepare.batch:type_name -> protobufs.Batch
	3,  // 1: protobufs.PbftPreprepare.hset:type_name -> protobufs.HtnMessage
	10, // 2: protobufs.PbftViewChange.pset:type_name -> protobufs.PbftViewChange.PsetEntry
	11, // 3: protobufs.PbftViewChange.qset:type_name -> protobufs.PbftViewChange.QsetEntry
	15, // 4: protobufs.PbftViewChange.cset:type_name -> protobufs.CheckpointMsg
	0,  // 5: protobufs.PbftMissingPreprepare.preprepare:type_name -> protobufs.PbftPreprepare
	12, // 6: protobufs.PbftNewView.vset:type_name -> protobufs.PbftNewView.VsetEntry
	13, // 7: protobufs.PbftNewView.xset:type_name -> protobufs.PbftNewView.XsetEntry
	15, // 8: protobufs.PbftNewView.checkpoint:type_name -> protobufs.CheckpointMsg
	...
	16, // 11: protobufs.PbftNewView.VsetEntry.value:type_name -> protobufs.SignedMsg
