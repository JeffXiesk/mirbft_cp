...
messageBatchRates="8"       # (in msgs/ms) The number of peers divided by this number gives the message batch timeout in ms
...
nodeConnections="1"
minConnections="16"
leaderPolicies="Blacklist"  # Possible values:
