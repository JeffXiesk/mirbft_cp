...
do
    ssh $ssh_options_cloud root@${public_ip_arr[c]} 'tc qdisc del dev eth0 root;tc qdisc add dev eth0 root tbf rate 20mbit burst 320kbit latency 100ms'
    echo ${public_ip_arr[c]} '20mbit'
