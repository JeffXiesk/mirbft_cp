...
StragglerCnt=(1) # For each system size, the corresponding failure count (on top of the correct nodes)
...
throughputsAuthSinglePbft[4]="128"
throughputsAuthSinglePbft[8]="128"
