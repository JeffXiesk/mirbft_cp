...
type GlobalOrderer struct {
	...
	dispatcher  globalDispatcher     // map[int32]*pbftInstance
...
func (d *globalDispatcher) load(key int32) (*pbftInstance, bool) {
...
func (d *globalDispatcher) store(key int32, value *pbftInstance) {
	d.mm.Store(key, value)
}

func (d *globalDispatcher) delete(key int32) {
	d.mm.Delete(key)
}
