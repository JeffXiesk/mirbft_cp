...
type ProtocolMessage struct {
	...
	//	*ProtocolMessage_LogEntry
	//	*ProtocolMessage_GlobalPreprepare
	//	*ProtocolMessage_GlobalPrepare
	//	*ProtocolMessage_GlobalCommit
	Msg    isProtocolMessage_Msg `protobuf_oneof:"msg"`
	Type   string                `protobuf:"bytes,33,opt,name=type,proto3" json:"type,omitempty"`
	Height int32                 `protobuf:"varint,34,opt,name=height,proto3" json:"height,omitempty"`
}
...
func (x *ProtocolMessage) GetLogEntry() *LogEntry {
	if x, ok := x.GetMsg().(*ProtocolMessage_LogEntry); ok {
		return x.LogEntry
	}
	return nil
}

func (x *ProtocolMessage) GetGlobalPreprepare() *GlobalPreprepare {
	if x, ok := x.GetMsg().(*ProtocolMessage_GlobalPreprepare); ok {
		return x.GlobalPreprepare
	}
	return nil
}

func (x *ProtocolMessage) GetGlobalPrepare() *GlobalPrepare {
	if x, ok := x.GetMsg().(*ProtocolMessage_GlobalPrepare); ok {
		return x.GlobalPrepare
	}
	return nil
}

func (x *ProtocolMessage) GetGlobalCommit() *GlobalCommit {
	if x, ok := x.GetMsg().(*ProtocolMessage_GlobalCommit); ok {
...
func (x *ProtocolMessage) GetHeight() int32 {
	if x != nil {
		return x.Height
	}
	return 0
...
type ProtocolMessage_LogEntry struct {
	LogEntry *LogEntry `protobuf:"bytes,29,opt,name=log_entry,json=logEntry,proto3,oneof"`
}

type ProtocolMessage_GlobalPreprepare struct {
	GlobalPreprepare *GlobalPreprepare `protobuf:"bytes,30,opt,name=global_preprepare,json=globalPreprepare,proto3,oneof"`
}

type ProtocolMessage_GlobalPrepare struct {
	GlobalPrepare *GlobalPrepare `protobuf:"bytes,31,opt,name=global_prepare,json=globalPrepare,proto3,oneof"`
}

type ProtocolMessage_GlobalCommit struct {
	GlobalCommit *GlobalCommit `protobuf:"bytes,32,opt,name=global_commit,json=globalCommit,proto3,oneof"`
}
...
func (*ProtocolMessage_LogEntry) isProtocolMessage_Msg() {}

func (*ProtocolMessage_GlobalPreprepare) isProtocolMessage_Msg() {}

func (*ProtocolMessage_GlobalPrepare) isProtocolMessage_Msg() {}

func (*ProtocolMessage_GlobalCommit) isProtocolMessage_Msg() {}
...
var file_messenger_proto_rawDesc = []byte{
	...
	0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa2, 0x10, 0x0a,
	...
	,
...
var file_messenger_proto_goTypes = []interface{}{
	...
	(*LogEntry)(nil),                     // 24: protobufs.LogEntry
	(*GlobalPreprepare)(nil),             // 25: protobufs.GlobalPreprepare
	(*GlobalPrepare)(nil),                // 26: protobufs.GlobalPrepare
	(*GlobalCommit)(nil),                 // 27: protobufs.GlobalCommit
	(*ClientRequest)(nil),                // 28: protobufs.ClientRequest
	(*BucketSubscription)(nil),           // 29: protobufs.BucketSubscription
	(*ClientResponse)(nil),               // 30: protobufs.ClientResponse
	(*BucketAssignment)(nil),             // 31: protobufs.BucketAssignment
}
var file_messenger_proto_depIdxs = []int32{
	...
	24, // 26: protobufs.ProtocolMessage.log_entry:type_name -> protobufs.LogEntry
	25, // 27: protobufs.ProtocolMessage.global_preprepare:type_name -> protobufs.GlobalPreprepare
	26, // 28: protobufs.ProtocolMessage.global_prepare:type_name -> protobufs.GlobalPrepare
	27, // 29: protobufs.ProtocolMessage.global_commit:type_name -> protobufs.GlobalCommit
	0,  // 30: protobufs.ProtocolMessageBatch.msgs:type_name -> protobufs.ProtocolMessage
	0,  // 31: protobufs.Messenger.Listen:input_type -> protobufs.ProtocolMessage
	28, // 32: protobufs.Messenger.Request:input_type -> protobufs.ClientRequest
	29, // 33: protobufs.Messenger.Buckets:input_type -> protobufs.BucketSubscription
	3,  // 34: protobufs.Messenger.Listen:output_type -> protobufs.BandwidthTestAck
	30, // 35: protobufs.Messenger.Request:output_type -> protobufs.ClientResponse
	31, // 36: protobufs.Messenger.Buckets:output_type -> protobufs.BucketAssignment
...
func file_messenger_proto_init() {
	...
	file_messenger_proto_msgTypes[0].OneofWrappers = []interface{}{
		...
		(*ProtocolMessage_LogEntry)(nil),
		(*ProtocolMessage_GlobalPreprepare)(nil),
		(*ProtocolMessage_GlobalPrepare)(nil),
		(*ProtocolMessage_GlobalCommit)(nil),
	}
	type x struct{}
