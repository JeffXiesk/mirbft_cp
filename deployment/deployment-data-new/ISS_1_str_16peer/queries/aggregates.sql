...
--
select avg(request_truncated2.ts - r.ts) / 1000.0
from request_truncated2
         inner join request r on request_truncated2.clSn = r.clSn 
         and request_truncated2.nodeId = r.nodeId and r.event='REQ_SEND';
-- (avg[ms])
