...
# Push config files.
exec-start peers scp-output-0000-config.log stubborn-scp.sh 10 18.224.59.225:experiment-config/config-0000.yml config/config.yml
...
exec-start 16clients scp-output-0000-config.log stubborn-scp.sh 10 18.224.59.225:experiment-config/config-0000.yml config/config.yml
...
exec-start 16extraclients scp-output-0000-config.log stubborn-scp.sh 10 18.224.59.225:experiment-config/config-0000.yml config/config.yml
...
# Start peers.
discover-reset 16
exec-start peers experiment-output/0000/slave-__id__/peer.log orderingpeer config/config.yml 18.224.59.225:9999 __public_ip__ __private_ip__ experiment-output/0000/slave-__id__/peer.trc experiment-output/0000/slave-__id__/prof
discover-wait

# Run clients and wait for them to stop.
exec-start 16clients experiment-output/0000/slave-__id__/clients.log orderingclient config/config.yml 18.224.59.225:9999 experiment-output/0000/slave-__id__/client experiment-output/0000/slave-__id__/prof-client
exec-start 16extraclients experiment-output/0000/slave-__id__/clients.log orderingclient config/config.yml 18.224.59.225:9999 experiment-output/0000/slave-__id__/client experiment-output/0000/slave-__id__/prof-client
...
exec-start peers scp-output-0000-logs.log stubborn-scp.sh 10 experiment-output-0000-slave-__id__.tar.gz 18.224.59.225:current-deployment-data/raw-results/
...
exec-start 16clients scp-output-0000-logs.log stubborn-scp.sh 10 experiment-output-0000-slave-__id__.tar.gz 18.224.59.225:current-deployment-data/raw-results/
...
exec-start 16extraclients scp-output-0000-logs.log stubborn-scp.sh 10 experiment-output-0000-slave-__id__.tar.gz 18.224.59.225:current-deployment-data/raw-results/
