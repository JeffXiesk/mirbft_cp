...
# Push config files.
exec-start globalorderer scp-output--1-config.log stubborn-scp.sh 10 $own_public_ip:experiment-config/config-0000.yml config/config.yml
...
exec-start globalorderer experiment-output/0000/slave-__id__/peer.log globalorderpeer config/config.yml $own_public_ip:$master_port __public_ip__ __private_ip__ experiment-output/0000/slave-__id__/peer.trc experiment-output/0000/slave-__id__/prof
discover-wait
