...
func (hi *hotStuffInstance) handleProposal(proposal *pb.HotStuffProposal, msg *pb.ProtocolMessage) error {
	...
	// if (senderID+hi.fake_view)%int32(len(hi.segment.Followers())) != proposal.Leader {
	// 	hi.sendNewView()
...
func (hi *hotStuffInstance) sendVote(node *hotStuffNode, des int32) {
